...
//          in picker mode (onSelect supplied), as a per-character model
//          picker. Characters are populated by dropping files into
//          public/assets/library/characters/ — scenes are wired up but empty
//          until that folder gets real content.
...
import { Box, Clapperboard, Loader2 } from "lucide-react";
    ...
    <div className="flex flex-col gap-3">
      ...
      {isLoading ? (
        ...
        <p className="text-muted-foreground py-10 text-center text-sm">
          {category === "character"
            ? "No character models in the library yet — drop Mixamo FBX/GLB exports into public/assets/library/characters/."
            : "Scenes aren't supported yet — coming soon."}
        </p>
      ) : (
